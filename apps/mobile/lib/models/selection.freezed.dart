...
mixin _$Selection {
 ...
 String get outcomeId;/// The event this leg is on. Two legs sharing an `eventId` conflict in a
/// booking code — the Create picker uses this to keep one pick per match
/// (`docs/backend-api.md` §1, `docs/betway-api.md` §3).
 String get eventId; String get marketName; String get outcomeName; String get eventName; String get league; String get kickoffAt; double get odds; bool get isActive;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,outcomeId,eventId,marketName,outcomeName,eventName,league,kickoffAt,odds,isActive);

@override
String toString() {
  return 'Selection(outcomeId: $outcomeId, eventId: $eventId, marketName: $marketName, outcomeName: $outcomeName, eventName: $eventName, league: $league, kickoffAt: $kickoffAt, odds: $odds, isActive: $isActive)';
}
...
@useResult
$Res call({
 String outcomeId, String eventId, String marketName, String outcomeName, String eventName, String league, String kickoffAt, double odds, bool isActive
});
...
/// Create a copy of Selection
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? outcomeId = null,Object? eventId = null,Object? marketName = null,Object? outcomeName = null,Object? eventName = null,Object? league = null,Object? kickoffAt = null,Object? odds = null,Object? isActive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String outcomeId,  String eventId,  String marketName,  String outcomeName,  String eventName,  String league,  String kickoffAt,  double odds,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Selection() when $default != null:
return $default(_that.outcomeId,_that.eventId,_that.marketName,_that.outcomeName,_that.eventName,_that.league,_that.kickoffAt,_that.odds,_that.isActive);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String outcomeId,  String eventId,  String marketName,  String outcomeName,  String eventName,  String league,  String kickoffAt,  double odds,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _Selection():
return $default(_that.outcomeId,_that.eventId,_that.marketName,_that.outcomeName,_that.eventName,_that.league,_that.kickoffAt,_that.odds,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String outcomeId,  String eventId,  String marketName,  String outcomeName,  String eventName,  String league,  String kickoffAt,  double odds,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _Selection() when $default != null:
return $default(_that.outcomeId,_that.eventId,_that.marketName,_that.outcomeName,_that.eventName,_that.league,_that.kickoffAt,_that.odds,_that.isActive);case _:
  return null;
...
class _Selection implements Selection {
  const _Selection({required this.outcomeId, required this.eventId, required this.marketName, required this.outcomeName, required this.eventName, required this.league, required this.kickoffAt, required this.odds, required this.isActive});
...
/// Create a copy of Selection
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? outcomeId = null,Object? eventId = null,Object? marketName = null,Object? outcomeName = null,Object? eventName = null,Object? league = null,Object? kickoffAt = null,Object? odds = null,Object? isActive = null,}) {
